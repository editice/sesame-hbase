...
public abstract class RDFWriterTest {
	...
	public void testRoundTrip() throws RDFHandlerException, IOException,
		...
		assertTrue("missing statement with literal ending on newline",
				statements.contains(st4));
	}

	@Test
	public void testPrefixRedefinition() throws RDFHandlerException,
		...
		assertEquals("Written and parsed statements are not equal", st,
				parsedSt);
	}

	@Test
	public void testIllegalPrefix() throws RDFHandlerException,
			RDFParseException, IOException {
		String ns1 = "a:";
		String ns2 = "b:";
		String ns3 = "c:";
	...
	public void testDefaultNamespace() throws Exception {
		...
		rdfWriter.startRDF();
		rdfWriter.handleStatement(new StatementImpl(new URIImpl(RDF.NAMESPACE),
