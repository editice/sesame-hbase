...
public abstract class N3ParserTestCase {
	...
	private class PositiveParserTest extends TestCase {
		...
		public PositiveParserTest(String testURI, String inputURL,
				String outputURL) throws MalformedURLException {
			super(testURI);
		...
		protected void runTest() throws Exception {
			...
			if (!ModelUtil.equals(inputCollection, outputCollection)) {
				...
				List<Statement> missing = new LinkedList<Statement>(
						outputCollection);
				missing.removeAll(inputCollection);

				List<Statement> unexpected = new LinkedList<Statement>(
						inputCollection);
