...
public abstract class SPARQLSyntaxTest extends TestCase {
	...
	private static final Logger logger = LoggerFactory
			.getLogger(SPARQLSyntaxTest.class);
	...
	static {
		...
		sb
				.append("WHERE Type = mf:PositiveSyntaxTest or Type = mf:NegativeSyntaxTest ");
		sb.append("USING NAMESPACE");
		sb
				.append("  mf = <http://www.w3.org/2001/sw/DataAccess/tests/test-manifest#>,");
		sb
	...
	public SPARQLSyntaxTest(String testURI, String name, String queryFileURL,
	...
	public interface Factory {
		...
		SPARQLSyntaxTest createSPARQLSyntaxTest(String testURI,
	...
	public static Test suite(Factory factory) throws Exception {
		...
		if (REMOTE) {
			...
			URL url = SPARQLSyntaxTest.class
					.getResource("/testcases-dawg/data-r2/");
		...
		for (String subManifest : subManifestList) {
			...
			while (tests.hasNext()) {
				...
				boolean positiveTest = bindingSet
						.getValue("Type")
						.toString()
						.equals(
