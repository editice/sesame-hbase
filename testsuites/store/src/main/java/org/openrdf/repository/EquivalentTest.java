...
public abstract class EquivalentTest extends TestCase {
	...
	private static Literal xyz_string = vf.createLiteral("xyz",
			XMLSchema.STRING);

	private static Literal xyz_integer = vf.createLiteral("xyz",
			XMLSchema.INTEGER);
	...
	private static Literal abc_string = vf.createLiteral("abc",
			XMLSchema.STRING);

	private static Literal abc_integer = vf.createLiteral("abc",
			XMLSchema.INTEGER);
