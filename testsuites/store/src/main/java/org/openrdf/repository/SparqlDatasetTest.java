...
public abstract class SparqlDatasetTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		george = createUser("george", "George Harrison", "george@example.org",
				graph1);
	...
	private URI createUser(String id, String name, String email,
		...
		conn.add(subj, RDF.TYPE, vf.createURI("http://xmlns.com/foaf/0.1/",
				"Person"), context);
