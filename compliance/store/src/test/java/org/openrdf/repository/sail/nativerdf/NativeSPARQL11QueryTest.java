...
public class NativeSPARQL11QueryTest extends SPARQLQueryTest {
	...
	public static Test suite() throws Exception {
		return SPARQL11ManifestTest.suite(new Factory() {
			...
			public NativeSPARQL11QueryTest createSPARQLQueryTest(
			...
			public NativeSPARQL11QueryTest createSPARQLQueryTest(
				...
				return new NativeSPARQL11QueryTest(testURI, name, queryFileURL,
	...
	protected NativeSPARQL11QueryTest(String testURI, String name,
	...
	protected Repository newRepository() throws IOException {
		...
		return new DatasetRepository(new SailRepository(new NativeStore(
				dataDir, "spoc")));
	}
