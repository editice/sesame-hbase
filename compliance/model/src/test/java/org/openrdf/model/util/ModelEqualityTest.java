...
public class ModelEqualityTest extends TestCase {
	...
	public void testFoafExampleAdvanced() throws Exception {
	...
	private void testFilesEqual(String file1, String file2) throws Exception {
		...
		// System.out.println("Model equality checked in " + (endTime -
		// startTime)
		// + "ms (" + file1 + ", " + file2
		// + ")");
	...
	private Set<Statement> loadModel(String fileName) throws Exception {
		...
		assertNotNull("Unable to determine RDF format for file: " + fileName,
				rdfFormat);
