...
public class CoreSPARQL11SyntaxTest extends SPARQL11SyntaxTest {
	...
	public static Test suite() throws Exception {
		return SPARQL11SyntaxTest.suite(new Factory() {
			...
			public SPARQL11SyntaxTest createSPARQLSyntaxTest(String testURI,
				...
				return new CoreSPARQL11SyntaxTest(testURI, testName,
						testAction, positiveTest);
			}
		});
	}

	public CoreSPARQL11SyntaxTest(String testURI, String name,
	...
	protected void parseOperation(String operation, String fileURL)
		...
		QueryParserUtil
				.parseOperation(QueryLanguage.SPARQL, operation, fileURL);
	}
}
