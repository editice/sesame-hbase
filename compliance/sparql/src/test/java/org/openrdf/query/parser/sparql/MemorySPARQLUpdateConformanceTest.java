 ...
 * @author jeen
 */
public class MemorySPARQLUpdateConformanceTest extends
		SPARQLUpdateConformanceTest {

	public MemorySPARQLUpdateConformanceTest(String testURI, String name,
	...
	public static Test suite() throws Exception {
		return SPARQL11ManifestTest.suite(new Factory() {
			...
			public MemorySPARQLUpdateConformanceTest createSPARQLUpdateConformanceTest(
					...
					Map<String, URI> resultNamedGraphs) {
				return new MemorySPARQLUpdateConformanceTest(testURI, name,
