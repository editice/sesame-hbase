...
public class TurtleParser extends RDFParserBase {
	...
	protected void parseDirective() throws IOException, RDFParseException,
			RDFHandlerException {
	...
	protected void parsePrefixID() throws IOException, RDFParseException,
			RDFHandlerException {
		skipWSC();
	...
	protected void parseBase() throws IOException, RDFParseException,
			RDFHandlerException {
		skipWSC();
	...
	protected void parseTriples() throws IOException, RDFParseException,
			RDFHandlerException {
		parseSubject();
		skipWSC();
	...
	protected void parsePredicateObjectList() throws IOException,
	...
	protected void parseObjectList() throws IOException, RDFParseException,
			RDFHandlerException {
		parseObject();
	...
	protected void parseSubject() throws IOException, RDFParseException,
			RDFHandlerException {
		int c = peek();
	...
	protected void parseObject() throws IOException, RDFParseException,
			RDFHandlerException {
		int c = peek();
	 ...
	 */
	protected Resource parseCollection() throws IOException, RDFParseException,
			RDFHandlerException {
		verifyCharacter(read(), "(");
	 ...
	 */
	protected Resource parseImplicitBlank() throws IOException,
			RDFParseException, RDFHandlerException {
		verifyCharacter(read(), "[");
	 ...
	 * datatype.
	 */
	protected Literal parseQuotedLiteral() throws IOException,
			RDFParseException {
