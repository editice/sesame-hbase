...
public class NTriplesUtil {
	...
	public static Value parseValue(String nTriplesValue,
			ValueFactory valueFactory) throws IllegalArgumentException {
		if (nTriplesValue.startsWith("<")) {
			...
			throw new IllegalArgumentException("Not a legal N-Triples value: "
					+ nTriplesValue);
		}
	}
	...
	public static URI parseURI(String nTriplesURI, ValueFactory valueFactory)
		...
		if (nTriplesURI.startsWith("<") && nTriplesURI.endsWith(">")) {
			...
			throw new IllegalArgumentException("Not a legal N-Triples URI: "
					+ nTriplesURI);
		}
	}
	...
	public static Literal parseLiteral(String nTriplesLiteral,
		...
		if (nTriplesLiteral.startsWith("\"")) {
			...
			if (endLabelIdx != -1) {
				...
				if (startLangIdx != -1) {
					// Get language
					String language = nTriplesLiteral
							.substring(startLangIdx + 1);
		...
		throw new IllegalArgumentException("Not a legal N-Triples literal: "
				+ nTriplesLiteral);
	}
