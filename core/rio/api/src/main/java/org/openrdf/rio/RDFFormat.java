...
public class RDFFormat extends FileFormat {
	 ...
	 * type is <code>application/rdf+xml</code>, but
	 * <code>application/xml</code> is also accepted. The character encoding is
	 * UTF-8.
	 * </p>
	 * 
	 * @see http://www.w3.org/TR/rdf-syntax-grammar/
	 */
	public static final RDFFormat RDFXML = new RDFFormat("RDF/XML", Arrays
			.asList("application/rdf+xml", "application/xml"), Charset
			.forName("UTF-8"), Arrays.asList("rdf", "rdfs", "owl", "xml"),
			true, false);
	...
	public static final RDFFormat NTRIPLES = new RDFFormat("N-Triples",
			"text/plain", Charset.forName("US-ASCII"), "nt", false, false);
	 ...
	 */
	public static final RDFFormat TURTLE = new RDFFormat("Turtle", Arrays
			.asList("text/turtle", "application/x-turtle"), Charset
			.forName("UTF-8"), Arrays.asList("ttl"), true, false);

	/**
	 * The <a
	 * href="http://www.w3.org/DesignIssues/Notation3.html">N3/Notation3</a>
	 * file format.
	 * <p>
	 ...
	 */
	public static final RDFFormat N3 = new RDFFormat("N3", "text/rdf+n3",
			Charset.forName("UTF-8"), "n3", true, false);
	...
	public static final RDFFormat TRIX = new RDFFormat("TriX",
			"application/trix", Charset.forName("UTF-8"), Arrays.asList("xml",
					"trix"), false, true);

	/**
	 * The <a
	 * href="http://www.wiwiss.fu-berlin.de/suhl/bizer/TriG/Spec/">TriG</a> file
	 * format, a Turtle-based RDF serialization format that supports recording
	 * of named graphs.
	 * <p>
	...
	public static final RDFFormat TRIG = new RDFFormat("TriG",
			"application/x-trig", Charset.forName("UTF-8"), "trig", true, true);
	...
	public static final RDFFormat BINARY = new RDFFormat("BinaryRDF",
			"application/x-binary-rdf", null, "brf", true, true);

	/**
	 * The <a href="http://sw.deri.org/2008/07/n-quads/">N-Quads</a> file
	 * format, an RDF serialization format that supports recording of named
	 * graphs.
	 * <p>
	...
	public static final RDFFormat NQUADS = new RDFFormat("N-Quads",
			"text/x-nquads", Charset.forName("US-ASCII"), "nq", false, true);
	 ...
	 */
	public static RDFFormat register(String name, String mimeType,
			String fileExt, Charset charset) {
		RDFFormat rdfFormat = new RDFFormat(name, mimeType, charset, fileExt,
				false, false);
		register(rdfFormat);
		return rdfFormat;
	}
	 ...
	 * @param mimeType
	 *            A file name.
	 * @return An RDFFormat that matches the MIME type, or the fallback format
	 ...
	 * @param fileName
	 *            A file name.
	 * @return An RDFFormat that matches the file name extension, or the
	...
	public static List<String> getAcceptParams(Iterable<RDFFormat> rdfFormats,
			boolean requireContext, RDFFormat preferredFormat) {
	 ...
	 *            <tt>rdf</tt> for RDF/XML files.
	 */
	public RDFFormat(String name, String mimeType, Charset charset,
			String fileExtension, boolean supportsNamespaces,
			boolean supportsContexts) {
		this(name, Arrays.asList(mimeType), charset, Arrays
				.asList(fileExtension), supportsNamespaces, supportsContexts);
	}
	 ...
	 *            RDF/XML files. The first item in the list is interpreted as
	 ...
	 *            first item in the list is interpreted as the default MIME type
	 *            for the format.
	 * @param charset
	 *            The default character encoding of the RDF file format. Specify
	 *            <tt>null</tt> if not applicable.
	 ...
	 *            the default file extension for the format.
	 */
	public RDFFormat(String name, Collection<String> mimeTypes,
