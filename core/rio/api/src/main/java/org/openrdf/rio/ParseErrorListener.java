...
public interface ParseErrorListener {
	 ...
	 *            A warning message.
	 * @param lineNo
	 *            A line number related to the warning, or -1 if not available
	 *            or applicable.
	 * @param colNo
	 *            A column number related to the warning, or -1 if not available
	 *            or applicable.
	 */
	 ...
	 *            applicable.
	 * @param colNo
	 *            A column number related to the error, or -1 if not available
	 *            or applicable.
