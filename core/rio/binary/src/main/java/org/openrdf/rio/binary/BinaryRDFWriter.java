...
public class BinaryRDFWriter implements RDFWriter {
	...
	private Integer assignValueId(Value v) throws IOException,
			RDFHandlerException {
	...
	private void writeValue(Value value) throws RDFHandlerException,
			IOException {
		if (value instanceof URI) {
			...
			throw new RDFHandlerException("Unknown Value object type: "
					+ value.getClass());
		}
	}
