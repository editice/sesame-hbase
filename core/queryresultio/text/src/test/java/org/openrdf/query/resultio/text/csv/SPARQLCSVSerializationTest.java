...
public class SPARQLCSVSerializationTest extends
		TupleQueryResultSerializationTest {
	...
	public void testSPARQLResultFormat() throws IOException,
		...
		// TODO disabled for now since CSV format is lossy and therefore does
		// not provide round-trip
