...
public class TupleQueryResultSerializationTestzj extends TestCase {

	public void testSPARQLResultFormat() throws IOException,
	...
	private TupleQueryResult createQueryResult() {
		...
		List<? extends BindingSet> bindingSetList = Arrays.asList(solution1,
				solution2);

		TupleQueryResultImpl result = new TupleQueryResultImpl(bindingNames,
				bindingSetList);
