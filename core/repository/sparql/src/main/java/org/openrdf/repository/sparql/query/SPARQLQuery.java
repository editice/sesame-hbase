...
public abstract class SPARQLQuery implements Query {
	...
	public void setMaxQueryTime(int maxQueryTime) {
		...
		this.client.getParams().setConnectionManagerTimeout(
				1000L * maxQueryTime);
	}
	...
	protected HttpMethodBase getResponse() throws HttpException, IOException,
		...
		Map<String, String> additionalHeaders = (Map<String, String>) client
				.getParams().getParameter(
						SPARQLConnection.ADDITIONAL_HEADER_NAME);
		if (additionalHeaders != null) {
			for (Entry<String, String> additionalHeader : additionalHeaders
					.entrySet())
				post.addRequestHeader(additionalHeader.getKey(),
						additionalHeader.getValue());
		}
