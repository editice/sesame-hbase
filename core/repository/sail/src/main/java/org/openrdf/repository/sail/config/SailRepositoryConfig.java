...
public class SailRepositoryConfig extends RepositoryImplConfigBase {
	...
	public void validate() throws RepositoryConfigException {
		...
		if (sailImplConfig == null) {
			throw new RepositoryConfigException(
					"No Sail implementation specified for Sail repository");
		}
	...
	public void parse(Graph graph, Resource repImplNode)
		...
		try {
			Resource sailImplNode = GraphUtil.getOptionalObjectResource(graph,
					repImplNode, SAILIMPL);

			if (sailImplNode != null) {
				Literal typeLit = GraphUtil.getOptionalObjectLiteral(graph,
						sailImplNode, SAILTYPE);
