...
public class SailRepositoryConnection extends RepositoryConnectionBase {
	 ...
	 */
	protected SailRepositoryConnection(SailRepository repository,
	...
	public SailTupleQuery prepareTupleQuery(QueryLanguage ql,
		...
		ParsedTupleQuery parsedQuery = QueryParserUtil.parseTupleQuery(ql,
				queryString, baseURI);
	...
	public SailGraphQuery prepareGraphQuery(QueryLanguage ql,
			String queryString, String baseURI) throws MalformedQueryException {
		ParsedGraphQuery parsedQuery = QueryParserUtil.parseGraphQuery(ql,
				queryString, baseURI);
	...
	public SailBooleanQuery prepareBooleanQuery(QueryLanguage ql,
			String queryString, String baseURI) throws MalformedQueryException {
		ParsedBooleanQuery parsedQuery = QueryParserUtil.parseBooleanQuery(ql,
				queryString, baseURI);
	...
	public Update prepareUpdate(QueryLanguage ql, String update, String baseURI)
		...
		ParsedUpdate parsedUpdate = QueryParserUtil.parseUpdate(ql, update,
				baseURI);
	...
	public RepositoryResult<Resource> getContextIDs()
		...
		try {
			...
			throw new RepositoryException(
					"Unable to get context IDs from Sail", e);
		}
	}
	...
	public RepositoryResult<Statement> getStatements(Resource subj, URI pred,
		...
		try {
			return createRepositoryResult(sailConnection.getStatements(subj,
					pred, obj, includeInferred, contexts));
		} catch (SailException e) {
			throw new RepositoryException("Unable to get statements from Sail",
					e);
		}
	}
	...
	public void exportStatements(Resource subj, URI pred, Value obj,
		...
		// Export statements
		CloseableIteration<? extends Statement, RepositoryException> stIter = getStatements(
	...
	public RepositoryResult<Namespace> getNamespaces()
		...
		try {
			...
			throw new RepositoryException("Unable to get namespaces from Sail",
					e);
		}
	}
