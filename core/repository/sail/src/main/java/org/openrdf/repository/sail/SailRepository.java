 ...
 * 
 * <pre>
 * Repository repository = new RepositoryImpl(new ForwardChainingRDFSInferencer(
 * 		new MemoryStore()));
...
public class SailRepository extends RepositoryBase {
	...
	/**
	 * Gets the Sail object that is on top of the Sail stack that this
	...
	public boolean isWritable() throws RepositoryException {
		try {
			...
			throw new RepositoryException(
					"Unable to determine writable status of Sail", e);
		}
	}
