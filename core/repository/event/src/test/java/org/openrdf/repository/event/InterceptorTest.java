...
public class InterceptorTest extends TestCase {
	...
	public void testUpdate() throws Exception {
		...
		InterceptingRepositoryConnection con = new InterceptingRepositoryConnectionWrapper(
				repo, stub);
		con
				.addRepositoryConnectionInterceptor(new RepositoryConnectionInterceptorAdapter() {

					public boolean execute(RepositoryConnection conn,
		...
		Update update = con.prepareUpdate(SPARQL, "DELETE DATA { <> <> <> }",
				"http://example.com/");
		update.execute();
	}
	...
	public void testRemove() throws Exception {
		...
		con
				.addRepositoryConnectionInterceptor(new RepositoryConnectionInterceptorAdapter() {
					...
					public boolean remove(RepositoryConnection conn,
