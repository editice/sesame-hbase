...
public class HTTPTupleQuery extends HTTPQuery implements TupleQuery {
	...
	public HTTPTupleQuery(HTTPRepositoryConnection con, QueryLanguage ql,
	...
	public TupleQueryResult evaluate() throws QueryEvaluationException {
		...
		try {
			return client.sendTupleQuery(queryLanguage, queryString, baseURI,
	...
	public void evaluate(TupleQueryResultHandler handler)
		...
		HTTPClient client = httpCon.getRepository().getHTTPClient();
		try {
			client.sendTupleQuery(queryLanguage, queryString, baseURI, dataset,
