...
public interface RepositoryConnection {
	 ...
	 *            The query string.
	 * @param baseURI
	 *            The base URI to resolve any relative URIs that are in the
	 *            query against, can be <tt>null</tt> if the query does not
	 ...
	 * 
	 * @param ql
	 *            The query language in which the update operation is
	 *            formulated.
	 * @param update
	 ...
	 * @param baseURI
	 *            The base URI to resolve any relative URIs that are in the
	 *            update against, can be <tt>null</tt> if the update does not
	 *            contain any relative URIs.
	 * @throws MalformedQueryException
	 *             If the supplied update operation string is malformed.
	 */
	 ...
	 *            inferred statements are returned if available. The default is
	 *            true.
	 ...
	 *            wildcard.
	 * @param contexts
	 *            The context(s) the need to be searched. Note that this
	 *            parameter is a vararg and as such is optional. If no contexts
	 *            are supplied the method operates on the entire repository.
	 * @param includeInferred
	 *            if false, no inferred statements are considered; if true,
	 *            inferred statements are considered if available
	 ...
	 * 
	 * @param st
	 *            The statement to look for. Context information in the
	 ...
	 * 
	 * @throws RepositoryException
	 *             In case the mode switch failed, for example because a
	 *             currently active transaction failed to commit.
	 * @see #commit
	 */
	 ...
	 *            supplied the method ignores contextual information in the
	 *            actual data. If no contexts are supplied the contextual
	 *            information in the input stream is used, if no context
	 *            information is available the data is added without any
	 *            context.
	 * @throws IOException
	 ...
	 *            vararg and as such is optional. If no contexts are specified,
	 *            the data is added to any context specified in the actual data
	 *            file, or if the data contains no context, it is added without
	 *            context. If one or more contexts are specified the data is
	 *            added to these contexts, ignoring any context information in
	 *            the data itself.
	 * @throws IOException
	 ...
	 * @param contexts
	 *            The contexts to add the statements to. Note that this
	 *            parameter is a vararg and as such is optional. If no contexts
	 *            are specified, the statement is added to any context specified
	 *            in each statement, or if the statement contains no context, it
	 *            is added without context. If one or more contexts are
	 *            specified the statement is added to these contexts, ignoring
	 ...
	 *            The contexts to add the statements to. Note that this
	 *            parameter is a vararg and as such is optional. If no contexts
	 *            are specified, each statement is added to any context
	 *            specified in the statement, or if the statement contains no
	 *            context, it is added without context. If one or more contexts
	 *            are specified each statement is added to these contexts,
	 ...
	 *            {@link CloseableIteration}, it will be closed before this
	 *            method returns.
	 * @param contexts
	 *            The contexts to add the statements to. Note that this
	 *            parameter is a vararg and as such is optional. If no contexts
	 ...
	 * @param contexts
	 *            The context(s) to remove the data from. Note that this
	 *            parameter is a vararg and as such is optional. If no contexts
	 *            are supplied the method operates on the entire repository.
	 * @throws RepositoryException
	 *             If the statement(s) could not be removed from the repository,
	 *             for example because the repository is not writable.
	 */
	 ...
	 *            The context(s) to remove the data from. Note that this
	 *            parameter is a vararg and as such is optional. If no contexts
	 *            are supplied the method operates on the contexts associated
	 *            with the statement itself, and if no context is associated
	 *            with the statement, on the entire repository.
	 * @throws RepositoryException
	 *             If the statement could not be removed from the repository,
	 *             for example because the repository is not writable.
	 */
	 ...
	 *            with the statement, on the entire repository.
	 * @throws RepositoryException
	 *             If the statements could not be removed from the repository,
	 *             for example because the repository is not writable.
	 */
	 ...
	 * @throws RepositoryException
	 *             If the namespace could not be set in the repository, for
	 *             example because the repository is not writable.
	 * @throws NullPointerException
