...
public interface RepositoryFactory {
	 ...
	 * Repository types are used for identification and should uniquely identify
	 * specific implementations of the Repository API. This type <em>can</em> be
	 * equal to the fully qualified class name of the repository, but this is
	 * not required.
	 */
