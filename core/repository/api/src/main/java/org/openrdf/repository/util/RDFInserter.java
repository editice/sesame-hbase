...
public class RDFInserter extends RDFHandlerBase {
	 ...
	 * 
	 * @param contexts
	 *            the contexts to use. Use an empty array (not null!) to
	 *            indicate no context(s) should be enforced.
	 */
...
//		System.err.println(st.getClass().getName());
//		System.err.println("----");
...
//		System.err.println(subj.toString()+pred+obj);
	...
	/**
	 * Maps the supplied BNode, which comes from the data, to a new BNode
	 * object. Consecutive calls with equal BNode objects returns the same
	 * object everytime.
	 * 
