...
public interface BindingSet extends Iterable<Binding>, Serializable {
	 ...
	 * returns bindings with non-null values. An implementation is free to
	 * return the bindings in arbitrary order.
	 */
	 ...
	 * @param bindingName
	 *            The name of the binding.
	 * @return The value of the binding with the specified name, or
	 *         <tt>null</tt> if there is no such binding in this BindingSet.
	 */
