...
public interface Dataset {
	...
	/**
	 * Gets the default remove graph URIs of this dataset. An empty set
	 * indicates the the store's default behaviour should be used, if not
	 * otherwise indicated in the operation.
	 */
	public Set<URI> getDefaultRemoveGraphs();

	/**
	 * Gets the default insert graph URI of this dataset. An null value
	 * indicates that the store's default behaviour should be used, if not
	 * otherwise indicated in the operation.
	 */
	 ...
	 * set are empty, that indicates that the store's default behaviour should
	 * be used.
	 */
