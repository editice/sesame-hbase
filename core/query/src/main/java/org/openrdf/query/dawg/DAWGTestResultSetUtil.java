...
public class DAWGTestResultSetUtil {
	...
	public static TupleQueryResult toTupleQueryResult(
	...
	public static Graph toGraph(TupleQueryResult tqr)
		...
		DAWGTestResultSetWriter writer = new DAWGTestResultSetWriter(
				new StatementCollector(graph));
	...
	public static boolean toBooleanQueryResult(
			Iterable<? extends Statement> dawgGraph)
			throws DAWGTestResultSetParseException {
