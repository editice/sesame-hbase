...
public abstract class ExceptionConvertingIteration<E, X extends Exception>
	 ...
	 */
	public ExceptionConvertingIteration(
	 ...
	 * 
	 * @return <tt>true</tt> if the underlying Iteration contains more elements,
	...
	/**
	 * Closes this Iteration as well as the wrapped Iteration if it happens to
