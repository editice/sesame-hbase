 ...
 */
public abstract class FilterIteration<E, X extends Exception> extends
	 ...
	 * Iteration. All objects from the wrapped Iteration pass through this
	 * method in the same order as they are coming from the wrapped Iteration.
	 * 
	 * @param object
