 ...
 * class <tt>IterationWrapper</tt> itself provides default methods that forward
 * method calls to the wrapped Iteration. Subclasses of
 * <tt>IterationWrapper</tt> should override some of these methods and may also
 * provide additional methods and fields.
 */
public class IterationWrapper<E, X extends Exception> extends
	 ...
	 *             operation.
	 * @throws IllegalStateException
	 *             if the Iteration has been closed, or if {@link #next} has not
	 *             yet been called, or {@link #remove} has already been called
