 ...
 */
public abstract class CloseableIterationBase<E, X extends Exception> implements
	...
	/**
	 * Called by {@link #close} when it is called for the first time. This
	 * method is only called once on each iteration. By default, this method
	 * does nothing.
	 * 
	 * @throws X
	 */
