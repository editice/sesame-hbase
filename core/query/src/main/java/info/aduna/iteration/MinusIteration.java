 ...
 */
public class MinusIteration<E, X extends Exception> extends
		FilterIteration<E, X> {
	 ...
	 */
	public MinusIteration(Iteration<? extends E, X> leftArg,
	 ...
	 */
	public MinusIteration(Iteration<? extends E, X> leftArg,
			Iteration<? extends E, X> rightArg, boolean distinct) {
		super(leftArg);
