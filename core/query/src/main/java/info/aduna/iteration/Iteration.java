 ...
 * @param <X>
 *            Exception type that is thrown when a problem occurs during
 *            iteration.
...
public interface Iteration<E, X extends Exception> {
	 ...
	 *             if the iteration has no more elements or if it has been
	 *             closed.
	 */
	 ...
	 *             If the Iteration has been closed, or if <tt>next()</tt> has
	 *             not yet been called, or <tt>remove()</tt> has already been
	 *             called after the last call to <tt>next()</tt>.
	 */
