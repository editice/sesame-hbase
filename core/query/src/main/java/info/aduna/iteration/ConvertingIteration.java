 ...
 * <tt>S</tt> (the source type) to an iteration over objects of type <tt>T</tt>
 * (the target type).
 */
public abstract class ConvertingIteration<S, T, X extends Exception> extends
		CloseableIterationBase<T, X> {
	 ...
	 * 
	 * @param iter
	 *            The source type iteration for this
	 *            <tt>ConvertingIteration</tt>, must not be <tt>null</tt>.
	 */
