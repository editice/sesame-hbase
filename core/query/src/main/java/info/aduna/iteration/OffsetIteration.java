...
/**
 * An Iteration that skips the first <tt>offset</tt> elements from an underlying
 * Iteration.
 */
public class OffsetIteration<E, X extends Exception> extends
		FilterIteration<E, X> {
	 ...
	 * @param offset
	 *            The number of elements to skip, must be larger than or equal
	 *            to 0.
	 */
