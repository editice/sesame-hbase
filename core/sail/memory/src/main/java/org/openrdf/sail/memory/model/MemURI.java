...
public class MemURI implements URI, MemResource {
	...
	public boolean equals(Object other) {
		...
		if (other instanceof MemURI) {
			...
			return namespace.equals(o.getNamespace())
					&& localName.equals(o.getLocalName());
		} else if (other instanceof URI) {
			String otherStr = other.toString();

			return namespace.length() + localName.length() == otherStr.length()
					&& otherStr.endsWith(localName)
	...
	public boolean hasStatements() {
		return subjectStatements != null || predicateStatements != null
				|| objectStatements != null || contextStatements != null;
	}
