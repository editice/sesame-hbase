...
public class MemStatement extends ContextStatementImpl {
	...
	public MemStatement(MemResource subject, MemURI predicate, MemValue object,
			MemResource context, int sinceSnapshot) {
	 ...
	 */
	public MemStatement(MemResource subject, MemURI predicate, MemValue object,
			MemResource context, boolean explicit, int sinceSnapshot) {
		this(subject, predicate, object, context, explicit, sinceSnapshot,
				TxnStatus.NEUTRAL);
	}
