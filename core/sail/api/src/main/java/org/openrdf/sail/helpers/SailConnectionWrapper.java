...
public class SailConnectionWrapper implements SailConnection {
	...
	public CloseableIteration<? extends BindingSet, QueryEvaluationException> evaluate(
		...
		return wrappedCon.evaluate(tupleExpr, dataset, bindings,
				includeInferred);
	}
	...
	public CloseableIteration<? extends Statement, SailException> getStatements(
		...
		return wrappedCon.getStatements(subj, pred, obj, includeInferred,
				contexts);
	}
	...
	public void executeUpdate(UpdateExpr updateExpr, Dataset dataset,
		...
		wrappedCon
				.executeUpdate(updateExpr, dataset, bindings, includeInferred);
	}
}
