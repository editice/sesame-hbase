...
public interface NotifyingSailConnection extends SailConnection {
	...
	/**
	 * Registers a SailConnection listener with this SailConnection. The
	 * listener should be notified of any statements that are added or removed
	 * as part of this SailConnection.
	 * 
	 * @param listener
