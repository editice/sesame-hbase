 ...
 */
public class DelegatingSailImplConfigBase extends SailImplConfigBase implements
	...
	public void validate() throws SailConfigException {
		super.validate();
		if (delegate == null) {
			throw new SailConfigException("No delegate specified for "
					+ getType() + " Sail");
		}
		delegate.validate();
	}
	...
	public void parse(Graph graph, Resource implNode)
		...
		try {
			Resource delegateNode = GraphUtil.getOptionalObjectResource(graph,
					implNode, DELEGATE);
			if (delegateNode != null) {
				setDelegate(SailConfigUtil.parseRepositoryImpl(graph,
						delegateNode));
			}
