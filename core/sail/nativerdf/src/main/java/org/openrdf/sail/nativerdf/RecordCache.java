...
abstract class RecordCache {
	 ...
	 * {@link IllegalStateException} if the cache is no longer
	 * {@link #isValid() valid}.
	 * 
	 * @return
	...
	/**
	 * Checks whether the cache is still valid. Caches are valid if the number
	 * of stored records is smaller than or equal to the
	 * {@link #getMaxRecords() maximum number of records}.
	 */
