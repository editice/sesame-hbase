...
public abstract class ValueManagerBase<V extends RdbmsValue> extends
		ManagerBase {
	...
	public Number getInternalId(V value) throws SQLException,
	...
	public int getIdVersion() {
		return version.intValue()
				+ (hashes == null ? 0 : hashes.getIdVersion());
	}
	...
	protected abstract void insert(Number id, V value) throws SQLException,
			InterruptedException;
