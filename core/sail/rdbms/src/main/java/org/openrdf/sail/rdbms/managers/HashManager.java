...
public class HashManager extends ManagerBase {
	...
	private Map<Long, Number> lookup(Collection<RdbmsValue> values,
			Map<Long, Number> map) throws SQLException {
	...
	private void insert(RdbmsValue value) throws SQLException,
