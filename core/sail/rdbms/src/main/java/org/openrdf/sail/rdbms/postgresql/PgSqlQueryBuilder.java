...
/**
 * PostgreSQL-specific SQL query builder. Overrides default creation of LIMIT
 * clause when creating SQL query string.
 * 
...
public class PgSqlQueryBuilder extends SqlQueryBuilder {
	...
	public String toString() {
		...
		if (limit != null) {
			// For some reason, PostgreSQL does not accept full Java long values
			// as
			// values for the limit clause (despite it being within BigInt value
			// range).
