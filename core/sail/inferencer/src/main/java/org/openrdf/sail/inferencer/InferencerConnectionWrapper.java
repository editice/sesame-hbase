...
public class InferencerConnectionWrapper extends NotifyingSailConnectionWrapper
	 ...
	 * 
	 * @return The connection that was supplied to the constructor of this
	 *         class.
	 */
	@Override
	...
	public boolean addInferredStatement(Resource subj, URI pred, Value obj,
		...
		return getWrappedConnection().addInferredStatement(subj, pred, obj,
				contexts);
	}

	public boolean removeInferredStatement(Resource subj, URI pred, Value obj,
			Resource... contexts) throws SailException {
		return getWrappedConnection().removeInferredStatement(subj, pred, obj,
				contexts);
	}
