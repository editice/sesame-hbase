...
public class ASTServiceGraphPattern extends SimpleNode {
	...
	public String getPatternString() {
		...
		if (patternString == null) {
			...
			// determine part of the query behind the service pattern closing
			// bracket.
			String toTrimSuffix = sourceString;
			for (int i = 1; i < getEndTokenLinePos(); i++) {
				toTrimSuffix = toTrimSuffix.substring(toTrimSuffix
						.indexOf("\n") + 1);
			}
			toTrimSuffix = toTrimSuffix.substring(getEndTokenColumnPos() - 1);

			// trim off the end
			patternString = substring.substring(0, substring
					.lastIndexOf(toTrimSuffix) + 1);
		}
...
/*
 * JavaCC - OriginalChecksum=bee99d7e824ef3f88b61fe127af7e775 (do not edit this
 * line)
 */
