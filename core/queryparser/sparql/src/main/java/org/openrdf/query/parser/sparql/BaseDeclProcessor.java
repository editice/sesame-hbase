...
public class BaseDeclProcessor {
	 ...
	 *             If an external base URI is specified that is not an absolute
	 *             URI.
	 * @throws MalformedQueryException
	 *             If the base URI specified in the query model is not an
	 *             absolute URI.
	 */
		...
		if (baseDecl != null) {
			...
			if (!parsedBaseURI.isAbsolute()) {
				throw new IllegalArgumentException(
						"Supplied base URI is not an absolute IRI: "
								+ externalBaseURI);
			}
		} else {
