...
public interface SyntaxTreeBuilderTreeConstants {
	...
	public String[] jjtNodeName = { "QueryContainer", "void", "NamespaceDecl",
			"TupleUnion", "TupleMinus", "TupleIntersect", "GraphUnion",
			"GraphMinus", "GraphIntersect", "SelectQuery", "Select",
			"ProjectionElem", "ConstructQuery", "Construct", "QueryBody",
			"From", "Where", "OrderBy", "Limit", "Offset", "PathExprList",
			"PathExprUnion", "BasicPathExpr", "OptPathExpr",
			"BasicPathExprTail", "OptPathExprTail", "Edge", "Node", "NodeElem",
			"ReifiedStat", "OrderExpr", "Or", "And", "BooleanConstant", "Not",
			"Bound", "SameTerm", "IsResource", "IsLiteral", "IsURI", "IsBNode",
			"LangMatches", "Regex", "Exists", "Compare", "CompareAny",
			"CompareAll", "Like", "In", "InList", "CompOperator", "Var",
			"Datatype", "Lang", "Label", "Namespace", "LocalName", "Str",
			"FunctionCall", "ArgList", "URI", "QName", "BNode", "Literal",
			"String", "Null", };
}
/*
 * JavaCC - OriginalChecksum=57351b205d67e913125abf0f7b92feda (do not edit this
 * line)
 */
