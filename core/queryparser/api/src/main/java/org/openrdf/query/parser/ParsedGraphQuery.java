...
public class ParsedGraphQuery extends ParsedQuery {
	 ...
	 * 
	 * @param namespaces
	 *            A mapping of namespace prefixes to namespace names
	 *            representing the namespaces that are used in the query.
	 */
	 ...
	 * 
	 * @param tupleExpr
	 *            A tuple expression representing the query, formulated in Sail
	 *            Query Model objects.
	 */
