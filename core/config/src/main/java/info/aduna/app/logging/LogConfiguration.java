...
public interface LogConfiguration extends Configuration {
	 ...
	 * 
	 * @param baseDir
	 *            the base location on the file system for logging configuration
	 *            and data
	 * @throws IOException
	 */
	 ...
	 * 
	 * @return the base location on the file system for logging configuration
	 *         and data
	 */
	 ...
	 * 
	 * @return a reader that can read logging information as stored by the
	 *         logger configured through this LogConfiguration
	 */
