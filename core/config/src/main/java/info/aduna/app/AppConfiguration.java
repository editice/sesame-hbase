...
public class AppConfiguration implements Configuration {
	...
	public void load() throws IOException {
		properties = ConfigurationUtil.loadConfigurationProperties(
	 ...
	 * 
	 * @param args
	 *            A String array containing the arguments as specified to the
	 *            main method.
	 */
	 ...
	 * 
	 * @param dataDirParam
	 *            the data dir to use. If null, determination of the data dir
	 *            will be deferred to Platform.
	 */
	private void configureDataDir() {
		...
		if (dataDir == null) {
			dataDir = PlatformFactory.getPlatform().getApplicationDataDir(
					applicationId);
		}
	}
	...
	private LogConfiguration loadLogConfiguration()
		...
		throw new InstantiationException(classname
				+ " is not valid LogConfiguration instance!");
	}
