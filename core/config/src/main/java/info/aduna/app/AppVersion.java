...
public class AppVersion implements Comparable<AppVersion> {
	...
	public boolean equals(Object other) {
		...
		if (other instanceof AppVersion) {
			...
			if (isEqual) {
				isEqual = modifier == o.modifier || modifier != null
						&& modifier.equalsIgnoreCase(o.modifier);
			}
		}
	 ...
	 * lexicographically (based on the Unicode value of each character),
	 * ignoring case. Versions without a modifier are considered to be the
	 * "final" versions and come after otherwise equal versions with a modifier.
	 * 
	...
	public static AppVersion parse(String versionString) {
		...
		int modifierSeperator = versionString.indexOf('-', Math.max(
				minorSeperator, microSeperator));
