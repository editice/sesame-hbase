...
public class HttpServerUtilTest {
	...
	public void setUp() throws Exception {
		FileFormatServiceRegistry<? extends FileFormat, ?> registry = TupleQueryResultWriterRegistry
				.getInstance();
	...
	public void testSelectPreferredMIMEType1() {
		...
		ServletRequestStub testRequest = new ServletRequestStub(
				"application/sparql-results+json, */*");

		String preferredType = HttpServerUtil.selectPreferredMIMEType(
				tupleQueryMimeTypes.iterator(), testRequest);
	...
	public void testSelectPreferredMIMEType4() {
		...
		ServletRequestStub testRequest = new ServletRequestStub("*/*",
				"application/sparql-result+xml;q=0.9",
				"application/sparql-results+json");
	...
	public void testSelectPreferredMIMEType5() {
		...
		ServletRequestStub testRequest = new ServletRequestStub(
				"application/*", "application/sparql-results+json");
	...
	class ServletRequestStub implements javax.servlet.http.HttpServletRequest {
		...
		public ServletRequestStub(String... testHeaders) {
			this.testHeaders = Collections.enumeration(Arrays
					.asList(testHeaders));
		}
