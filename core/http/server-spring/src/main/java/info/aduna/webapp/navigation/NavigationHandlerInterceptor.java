...
public class NavigationHandlerInterceptor implements HandlerInterceptor {
	...
	public void postHandle(HttpServletRequest request,
		...
		NavigationModel sessionNavigationModel = (NavigationModel) request
				.getSession()
		...
		if (mav != null && sessionNavigationModel != null) {
			mav.addObject("view", sessionNavigationModel.findView(request
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if (session.getAttribute(NavigationModel.NAVIGATION_MODEL_KEY) == null) {
			session.setAttribute(NavigationModel.NAVIGATION_MODEL_KEY,
					getNavigationModel().clone());
		}
