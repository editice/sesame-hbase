...
public class RepositoryInterceptor extends ServerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request,
			HttpServletResponse respons, Object handler) throws Exception {
	...
	protected void setRequestAttributes(HttpServletRequest request)
		...
		if (repositoryID != null) {
			try {
				...
				// FIXME: hack for repositories that return connections that are
				// not
	...
	public static RepositoryConnection getRepositoryConnection(
		...
		return (RepositoryConnection) request
				.getAttribute(REPOSITORY_CONNECTION_KEY);
	}
}
