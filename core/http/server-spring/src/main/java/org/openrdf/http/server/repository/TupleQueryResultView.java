...
public class TupleQueryResultView extends QueryResultView {
	...
	public void render(Map model, HttpServletRequest request,
		...
		TupleQueryResultWriterFactory qrWriterFactory = (TupleQueryResultWriterFactory) model
				.get(FACTORY_KEY);
		TupleQueryResultFormat qrFormat = qrWriterFactory
		...
		try {
			...
			TupleQueryResult tupleQueryResult = (TupleQueryResult) model
