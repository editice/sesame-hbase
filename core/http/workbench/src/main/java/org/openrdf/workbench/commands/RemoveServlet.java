...
public class RemoveServlet extends TransformationServlet {
	...
	protected void doPost(WorkbenchRequest req, HttpServletResponse resp,
		...
		try {
			...
			try {
				...
				// HACK: HTML sends \r\n, but SAX strips out the \r, try both
				// ways
				if (obj instanceof Literal
						&& obj.stringValue().contains("\r\n")) {
	 ...
	 */
	private void remove(RepositoryConnection con, Resource subj, URI pred,
			Value obj, WorkbenchRequest req) throws BadRequestException,
			RepositoryException {
