 ...
 * <P>
 * Note that we introduce AVG as a first-class object into the algebra, despite
 * it being defined as a compound of other operators (namely, SUM and COUNT).
 * This allows us to more easily optimize evaluation.
 * 
