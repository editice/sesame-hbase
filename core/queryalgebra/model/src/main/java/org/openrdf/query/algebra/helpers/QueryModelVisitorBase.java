 ...
 */
public abstract class QueryModelVisitorBase<X extends Exception> implements
		QueryModelVisitor<X> {
	...
	protected void meetCompareSubQueryValueOperator(
			CompareSubQueryValueOperator node) throws X {
		meetSubQueryValueOperator(node);
	}
