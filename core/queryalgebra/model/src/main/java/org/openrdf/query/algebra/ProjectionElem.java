...
public class ProjectionElem extends QueryModelNodeBase {
	...
	public boolean equals(Object other) {
		if (other instanceof ProjectionElem) {
			...
			return sourceName.equals(o.getSourceName())
					&& targetName.equals(o.getTargetName());
		}
		return false;
	}
	 ...
	 */
	public void setAggregateOperatorInExpression(
			boolean aggregateOperatorInExpression) {
