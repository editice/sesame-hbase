 ...
 * @author jeen
 */
public class BottomUpJoinIterator extends
	...
	public BottomUpJoinIterator(EvaluationStrategy strategy, Join join,
		...
		while (currentScanElem == null) {
			...
			if (currentScanElem instanceof EmptyBindingSet) {
				...
				if (hashTable.containsKey(key)) {
					hashTableValues = new ArrayList<BindingSet>(hashTable
							.get(key));
				} else {
