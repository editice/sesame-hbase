 ...
 * 
 * Note that this class extends {@link LookAheadIteration} and thus any
 * implementation of this class is applicable for pipelining when used in a
 * different thread (access to shared variables is synchronized).
 * 
 * @author Andreas Schwarte
 */
public abstract class JoinExecutorBase<T> extends
		LookAheadIteration<T, QueryEvaluationException> {
	 ...
	 * </code>
	 * 
	 * and add results to rightQueue. Note that addResult() is implemented
	 * synchronized and thus thread safe. In case you can guarantee sequential
	 * access, it is also possible to directly access rightQueue
	 * 
	 */
