...
public class FilterIterator extends
		FilterIteration<BindingSet, QueryEvaluationException> {
	...
	protected boolean accept(BindingSet bindings)
		...
		try {
			...
			// FIXME J1 scopeBindingNames should include bindings from
			// superquery if the filter
			// is part of a subquery. This is a workaround: we should fix the
			// settings of scopeBindingNames,
