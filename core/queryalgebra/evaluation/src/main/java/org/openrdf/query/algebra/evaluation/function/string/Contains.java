...
public class Contains implements Function {
	...
	public Literal evaluate(ValueFactory valueFactory, Value... args)
		...
		if (leftVal instanceof Literal && rightVal instanceof Literal) {
			...
			if (leftLit.getLanguage() != null) {
				if (rightLit.getLanguage() == null
					...
					return BooleanLiteralImpl.valueOf(leftLexVal
							.contains(rightLexVal));
				} else {
					throw new ValueExprEvaluationException(
							"incompatible operands for CONTAINS function");
				}
			...
			throw new ValueExprEvaluationException(
					"CONTAINS function expects literal operands");
		}
