...
public class ServiceFallbackIteration extends JoinExecutorBase<BindingSet> {
	 ...
	 */
	public ServiceFallbackIteration(Service service, String preparedQuery,
	...
	protected void handleBindings() throws Exception {
		...
		for (BindingSet b : bindings) {
			CloseableIteration<BindingSet, QueryEvaluationException> result = federatedService
					.evaluate(preparedQuery, b, service.getBaseURI(),
