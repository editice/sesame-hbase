...
public class LiteralComparatorTest extends TestCase {
	...
	private Literal simple2 = vf
			.createLiteral("http://script.example/Кириллица");
	...
	protected void setUp() throws Exception {
		...
		XMLGregorianCalendar mar = factory
				.newXMLGregorianCalendar("2000-03-04T20:00:00Z");
		XMLGregorianCalendar oct = factory
				.newXMLGregorianCalendar("2002-10-10T12:00:00-05:00");
