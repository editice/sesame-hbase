...
public class ValueComparatorTest extends TestCase {
	...
	public void testBothBnode() throws Exception {
		...
		assertTrue(cmp.compare(bnode1, bnode2) == -1
				* cmp.compare(bnode2, bnode1));
	}
	...
	public void testOrder2() throws Exception {
		...
		List<Literal> valueList = Arrays.asList(en4, int10, int9, plain9,
				integer5, float9, plain4, plain10);
		Collections.sort(valueList, cmp);
