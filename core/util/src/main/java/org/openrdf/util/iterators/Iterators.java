...
public class Iterators {
	 ...
	 */
	public static <E, C extends Collection<E>> C addAll(
			Iterator<? extends E> iter, C collection) {
		while (iter.hasNext()) {
	 ...
	 * 
	 * @param iter
	 *            An iterator over arbitrary objects that are expected to
	 ...
	 */
	public static void toString(Iterator<?> iter, String separator,
			StringBuilder sb) {
		while (iter.hasNext()) {
			sb.append(iter.next());
