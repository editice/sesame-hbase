...
public class ObjectUtil {
	 ...
	 * @param o2
	 *            The second object
	 * @return <tt>true</tt> if both objects are <tt>null</tt>, if the object
	 *         references are identical, or if the objects are equal according
	 *         to the {@link Object#equals} method of the first object;
