...
public class XMLWriter {
	 ...
	 *            The name of the attribute.
	 * @param value
	 *            The value of the attribute. The integer value will be
	 ...
	 *            The name of the attribute.
	 * @param value
	 *            The value of the attribute. The boolean value will be
	 *            transformed to a string using the method
	 ...
	 *            The element name.
	 * @param value
	 *            The value. The integer value will be transformed to a string
