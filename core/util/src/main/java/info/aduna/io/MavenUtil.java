...
public class MavenUtil {
	...
	public static Properties loadPomProperties(String groupId, String artifactId)
			throws IOException {
		String properties = "META-INF/maven/" + groupId + "/" + artifactId
				+ "/pom.properties";
	 ...
	 *            The version number to return in case no version number was
	 *            found.
	 */
	public static String loadVersion(String groupId, String artifactId,
		...
		try {
			...
			LoggerFactory.getLogger(MavenUtil.class).warn(
