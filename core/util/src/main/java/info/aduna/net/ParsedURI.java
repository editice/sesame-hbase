...
public class ParsedURI implements java.lang.Cloneable {
	...
	/*
	 * // Tesing method public static void main(String[] args) throws Exception
	 * { URI baseURI = new URI(args[0]); baseURI.normalize();
	 * 
	 * URI uri = null;
	 * 
	 * for (int i = 0; i < 100; i++) { uri = baseURI.resolve(args[1]); }
	 * 
	 * try { Thread.sleep(1000); } catch (Exception e) {}
	 * 
	 * long startTime = System.currentTimeMillis(); for (int i = 0; i < 100;
	 * i++) { uri = baseURI.resolve(args[1]); } long endTime =
	 * System.currentTimeMillis();
	 * 
	 * System.out.println(args[0] + " was parsed as:");
	 * System.out.println("scheme = " + uri.getScheme());
	 * System.out.println("schemeSpecificPart = " +
	 * uri.getSchemeSpecificPart()); System.out.println("authority = " +
	 * uri.getAuthority()); System.out.println("path = " + uri.getPath());
	...
	public ParsedURI(String scheme, String authority, String path,
	...
	public boolean isSelfReference() {
		return _scheme == null && _authority == null && _query == null
				&& _path.length() == 0;
	}
	...
	public ParsedURI resolve(ParsedURI relURI) {
		...
		// RFC, step 2:
		if (relURI._authority == null && relURI._query == null
