...
public class StringUtil {
	...
	/**
	 * Returns all text occurring after the specified separator character, or
	 ...
	 * excludes whitespace and other special characters and is useful for
	 * display purposes (e.g. previews).
	 */
	public static String deriveInitialText(String text) {
		...
		while (startIdx < textLength && result == null) {
			...
			while (startIdx < textLength
					&& !isInitialTextStartChar(text.charAt(startIdx))) {
				startIdx++;
			}
			...
			while (endIdx < textLength
					&& ((endIdx - startIdx) < MAX_INITIAL_TEXT_LENGTH)
	 ...
	 * @return The trimmed string, or a reference to <tt>text</tt> if it did not
	 *         start and end with double quotes.
	 */
	public static String trimDoubleQuotes(String text) {
		int textLength = text.length();

		if (textLength >= 2 && text.charAt(0) == '"'
	...
	/**
	 * Concatenate a number of Strings. This implementation uses a
	 * StringBuilder.
	 * 
	 * @param strings
	...
	public static String concat(String... strings) {
		// Determine total length of concatenated string to prevent expensive
		// char
