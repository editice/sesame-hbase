...
public class LiteralUtil {
	...
	public static String getLabel(Value v, String fallback) {
		return v instanceof Literal ? getLabel((Literal) v, fallback)
				: fallback;
	}
	 ...
	 * @param fallback
	 *            The value to fall back to in case no byte value could gotten
	 *            from the literal.
	 ...
	 * @param fallback
	 *            The value to fall back to in case no short value could gotten
	 *            from the literal.
	...
	/**
	 * Gets the int value of the supplied literal. The fallback value is
	 * returned in case {@link Literal#intValue()} throws a
	 * {@link NumberFormatException}.
	 * 
	 * @param l
	 *            The literal to get the int value for.
	 * @param fallback
	 *            The value to fall back to in case no int value could gotten
	 *            from the literal.
	 ...
	 * @param fallback
	 *            The value to fall back to in case no long value could gotten
	 *            from the literal.
	 ...
	 * @param fallback
	 *            The value to fall back to in case no integer value could
	 *            gotten from the literal.
	 ...
	 * getIntegerValue((Literal)value, fallback)} in case the supplied value is
	 ...
	 * @param fallback
	 *            The value to fall back to in case no decimal value could
	 *            gotten from the literal.
	 ...
	 * getDecimalValue((Literal)value, fallback)} in case the supplied value is
	 * a literal, returns the fallback value otherwise.
	 */
	 ...
	 * @param fallback
	 *            The value to fall back to in case no float value could gotten
	 *            from the literal.
	 ...
	 * @param fallback
	 *            The value to fall back to in case no double value could gotten
	 *            from the literal.
	 ...
	 * @param fallback
	 *            The value to fall back to in case no boolean value could
	 *            gotten from the literal.
	 ...
	 * getBooleanValue((Literal)value, fallback)} in case the supplied value is
	 * a literal, returns the fallback value otherwise.
	 */
	 ...
	 * @param fallback
	 *            The value to fall back to in case no calendar value could
	 *            gotten from the literal.
	 ...
	 * occurs or the language tag represents an IANA-registred language tag),
