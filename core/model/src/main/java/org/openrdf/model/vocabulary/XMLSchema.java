...
public class XMLSchema {
	...
	static {
		...
		NORMALIZEDSTRING = factory.createURI(XMLSchema.NAMESPACE,
				"normalizedString");
		...
		NON_POSITIVE_INTEGER = factory.createURI(XMLSchema.NAMESPACE,
				"nonPositiveInteger");

		NEGATIVE_INTEGER = factory.createURI(XMLSchema.NAMESPACE,
				"negativeInteger");

		NON_NEGATIVE_INTEGER = factory.createURI(XMLSchema.NAMESPACE,
				"nonNegativeInteger");

		POSITIVE_INTEGER = factory.createURI(XMLSchema.NAMESPACE,
				"positiveInteger");
		...
		UNSIGNED_SHORT = factory
				.createURI(XMLSchema.NAMESPACE, "unsignedShort");
