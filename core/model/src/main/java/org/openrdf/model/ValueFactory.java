...
public interface ValueFactory {
	...
	/**
	 * Creates a new URI from the supplied namespace and local name. Calling
	 ...
	 * {@link URI#getLocalName()} are not necessarily the same as the values
	 * that are supplied to this method.
	 * 
	 * @param namespace
	 *            The URI's namespace.
	 * @param localName
	 ...
	 *            The literal's label.
	 * @param language
	 *            The literal's language attribute, or <tt>null</tt> if the
	 ...
	 *            The literal's label.
	 * @param datatype
	 *            The literal's datatype, or <tt>null</tt> if the literal
