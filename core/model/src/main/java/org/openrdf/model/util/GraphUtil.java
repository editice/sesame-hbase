...
public class GraphUtil {
	 ...
	 */
	public static Iterator<Resource> getSubjectIterator(Graph graph, URI pred,
	 ...
	 * {@link Graph#match(Resource, URI, Value, Resource[])} for a description
	 * of the parameter values.
	 */
	public static Set<Resource> getSubjects(Graph graph, URI pred, Value obj,
			Resource... contexts) {
	 ...
	 *             If the statements matched by the specified parameters do not
	 *             have exactly one unique subject.
	 */
	public static Resource getUniqueSubject(Graph graph, URI pred, Value obj,
			Resource... contexts) throws GraphUtilException {
		...
		if (subjects.size() == 1) {
			...
			throw new GraphUtilException("Multiple " + pred
					+ " properties found");
		}
	}
	 ...
	 *             {@link #getUniqueSubject(Graph, URI, Value, Resource[])} or
	 *             if its return value is not a URI.
	 */
	public static URI getUniqueSubjectURI(Graph graph, URI pred, Value obj,
			Resource... contexts) throws GraphUtilException {
	 ...
	 *             more than one unique subject.
	 */
	public static Resource getOptionalSubject(Graph graph, URI pred, Value obj,
			Resource... contexts) throws GraphUtilException {
		Set<Resource> subjects = getSubjects(graph, pred, obj, contexts);
	 ...
	 * @throws GraphUtilException
	 *             If such an exception is thrown by
	 *             {@link #getOptionalSubject(Graph, URI, Value, Resource[])} or
	 *             if its return value is not a URI.
	 */
	public static URI getOptionalSubjectURI(Graph graph, URI pred, Value obj,
			Resource... contexts) throws GraphUtilException {
	 ...
	 * description of the parameter values.
	 */
	public static Iterator<Value> getObjectIterator(Graph graph, Resource subj,
			URI pred, Resource... contexts) {
	 ...
	 * of the parameter values.
	 */
	public static Set<Value> getObjects(Graph graph, Resource subj, URI pred,
			Resource... contexts) {
	 ...
	 * are not met. See {@link Graph#match(Resource, URI, Value, Resource[])}
	 * for a description of the parameter values.
	 * 
	 * @return The object of the matched statement(s).
	 * @throws GraphUtilException
	 *             If the statements matched by the specified parameters do not
	 *             have exactly one unique object.
	 */
	public static Value getUniqueObject(Graph graph, Resource subj, URI pred,
			Resource... contexts) throws GraphUtilException {
	 ...
	 * Graph.
	 */
	public static void setUniqueObject(Graph graph, Resource subj, URI pred,
			Value obj, Resource... contexts) {
		Iterator<Statement> iter = graph.match(subj, pred, null, contexts);
	 ...
	 * @throws GraphUtilException
	 *             If such an exception is thrown by
	 *             {@link #getUniqueObject(Graph, Resource, URI, Resource[])} or
	 *             if its return value is not a Resource.
	 */
	public static Resource getUniqueObjectResource(Graph graph, Resource subj,
			URI pred) throws GraphUtilException {
		Value obj = getUniqueObject(graph, subj, pred);

		if (obj instanceof Resource) {
			return (Resource) obj;
		} else {
			throw new GraphUtilException(
					"Expected URI or blank node for property " + pred);
		}
	}
	 ...
	 */
	public static Literal getUniqueObjectLiteral(Graph graph, Resource subj,
			URI pred) throws GraphUtilException {
		Value obj = getUniqueObject(graph, subj, pred);
		...
		if (obj instanceof Literal) {
			...
			throw new GraphUtilException("Expected literal for property "
					+ pred);
		}
	}
	 ...
	 */
	public static Value getOptionalObject(Graph graph, Resource subj, URI pred,
			Resource... contexts) throws GraphUtilException {
		Set<Value> objects = getObjects(graph, subj, pred, contexts);
	 ...
	 * @throws GraphUtilException
	 *             If such an exception is thrown by
	 *             {@link #getOptionalObject(Graph, Resource, URI, Resource[])}
	 *             or if its return value is not a Resource.
	 */
	public static Resource getOptionalObjectResource(Graph graph,
			Resource subj, URI pred) throws GraphUtilException {
	 ...
	 *             If such an exception is thrown by
	 *             {@link #getOptionalObject(Graph, Resource, URI, Resource[])}
	 *             or if its return value is not a URI.
	 */
	 ...
	 *             If such an exception is thrown by
	 *             {@link #getOptionalObject(Graph, Resource, URI, Resource[])}
	 *             or if its return value is not a Literal.
	 */
	public static Literal getOptionalObjectLiteral(Graph graph, Resource subj,
			URI pred) throws GraphUtilException {
		Value obj = getOptionalObject(graph, subj, pred);
	...
	/**
	 * Utility method that removes all statements matching the specified
	 * criteria from a graph.
	 * 
	 * @param graph
	 ...
	 *             info.
	 */
	public static void remove(Graph graph, Resource subj, URI pred, Value obj,
			Resource... contexts) {
