...
public interface Literal extends Value {
	 ...
	 * @throws NumberFormatException
	 *             If the literal's label cannot be represented by a
	 *             <tt>short</tt>.
	 */
	 ...
	 * @throws NumberFormatException
	 *             If the literal's label cannot be represented by to a
	 *             <tt>long</tt>.
	 */
	...
	/**
	 * Returns the {@link XMLGregorianCalendar} value of this literal. A
	 * calendar representation can be given for literals whose label conforms to
	 * the syntax of the following <a
	 * href="http://www.w3.org/TR/xmlschema-2/">XML Schema datatypes</a>:
	 * <tt>dateTime</tt>, <tt>time</tt>, <tt>date</tt>, <tt>gYearMonth</tt>,
	 * <tt>gMonthDay</tt>, <tt>gYear</tt>, <tt>gMonth</tt> or <tt>gDay</tt>.
	 * 
